...
The Vercel helper disables automatic MCP tool-call retries. For any integration, keep retry behavior explicit around paid calls and preserve the original purchase parameters. If the outcome is unclear, retain the invocation identifier, check usage, and use [troubleshooting](/reference/troubleshooting) before creating another purchase.
