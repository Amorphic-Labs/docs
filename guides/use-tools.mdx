...
If the result is unhelpful, tell the agent what went wrong so it can report the outcome. A completed provider request can still produce an answer that does not meet your needs.
