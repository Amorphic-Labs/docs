...
<ParamField body="maxCostMicros" type="decimal string" required>
  Maximum initially authorized charge in USD credit micros. One dollar is `"1000000"`; ten cents is `"100000"`. Use `"0"` to authorize no positive charge unless revised terms are explicitly accepted.
</ParamField>
